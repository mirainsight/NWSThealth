...
def render_nwst_analytics_page(colors):
    ...
    st.markdown(
        '<div class="analytics-section-title">Attendance Trend (Saturdays)</div>',
        unsafe_allow_html=True,
    )
    ...
    st.markdown(
        '<div class="analytics-section-title">Average Attendance by Zone</div>',
        unsafe_allow_html=True,
    )
    ...
    st.markdown('<div class="analytics-section-title">Attendance rate by cell</div>', unsafe_allow_html=True)
    st.markdown(
    ...
    st.markdown(
        '<div class="analytics-section-title">Attendance by Cell Group</div>',
        unsafe_allow_html=True,
    )
                    ...
                    if att_df_m is not None and cg_df_m is not None:
                        ...
                        if monthly_status_df is not None and not monthly_status_df.empty:
                            ...
                            if _filtered_monthly.empty:
                                ...
                                # Name search: always one table for all matching rows. Per-cell tabs would
                                # leave Streamlit on the first tab so matches in other cells look "missing".
                                if _sel_names_mh:
                                    st.markdown(
